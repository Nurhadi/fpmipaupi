...
class Research_project extends CI_Controller
{
	...
	function index()
	{
		$page = $this->home_model->get_page('0000030');	
		if($page->num_rows() > 0)		
		{			
		...
		$this->load->view('research_project_view',$data);
	}
}

/* End of File : research_project.php */
/* Location : ./controllers/research_project.php */