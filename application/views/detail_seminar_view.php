									...
									<div class="span12">
										<div class="row">
											<div class="span5" id="breadcump">
												FPMIPA >> <a href="<?php echo site_url('seminar');?>" class="breadcump_child">Seminar</a> >> Detail Seminar
												<hr id="breadcump_line2">
											</div>
											<div class="span12">
												<div class="box_berita" style="padding:20px; padding-top:0px; font-size:0.8em;">
