...
<head>
	...
	<style>
		#container-header{background:#159CEA;}
		#box_main_menu, .box_title{background:#244061;}
		#box_main_menu2{background:#777777;}
	</style>
					...
					<div class="span12" id="container-content-a">
						<div class="row">
							<div class="span12" id="box_slider" style="position:relative; background:#999999;">
								<div style="background:rgba(0,0,0,0.4); height:235px; width:170px; position:absolute; float:left; z-index:4;">
									<span style="display:block; margin-left:12px; margin-top:10px; margin-bottom:5px; color:#fff; font-weight:bold;">Link</span>
									<div style="margin-left:10px;">
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 1</a>
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 2</a>
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 3</a>
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 4</a>
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 5</a>
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 6</a>
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 7</a>
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 8</a>
									</div>
								</div>
								...
								<div style="background:rgba(0,0,0,0.4); height:235px; width:170px; position:absolute; right:0px; float:right;">
									<span style="display:block; margin-left:12px; margin-top:10px; color:#fff; font-weight:bold;">Berita</span>
									<div style="margin-left:10px;">
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 1</a>
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 2</a>
										<a href="#" style="display:block; padding:2px; color:#fff;">Acara reuni akbar 3</a>
