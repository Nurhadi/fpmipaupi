																			...
																			<?php
																				...
																				// {
																					echo '<tr>
																							...
																							<td>Abdul Rozak</td>
																							<td>Matematika</td>
																							<td style="text-align:center;">04-05-1992</td>
																							<td style="text-align:center;"><a href="#">Lihat Detail</a></td>
																						</tr>';
																				// }
																			?>
																		</tbody>
																		...
																		<tbody>
																			<?php
																				...
																				// {
																					echo '<tr>
																							<td style="text-align:center;">1</td>
																							<td>Nurhadi Maulana Saint</td>
																							<td>IPA</td>
																							<td style="text-align:center;">23-09-1992</td>
																							<td style="text-align:center;"><a href="#">Lihat Detail</a></td>
																						</tr>';
																				// }
																			?>
