...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/transport.js');?>"></script>
</head>
<body>
<div id="container">
    <div id="content-big">
        ...
        <div id="main-content">
        	<div class="panel_title">Transport & Akomodasi</div>
            ...
            <div class="clear"></div>
            <div class="panel_big" id="for_transport_item">
            	<div class="panel_title">Transport & Akomodasi<a href="#" class="act" id="transport_item_add">add</a></div>
                <div class="panel_content lef">
                	<div id="transport_item_container">
                        <div id="transport_item_container_load">
                            <table id="transport_table" width="100%" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Title</th>
                                ...
                                <?php
									if($tr->num_rows()>0){
										foreach($tr->result() as $transport){
											echo "<tr>";
											echo "<td>".$transport->id_transport."</td>";
											echo "<td>".$transport->title."</td>";
											echo "<td align='center'>Rp ".number_format($transport->harga,0,'','.')." / ".$transport->satuan."</td>";
											echo "<td align='center'>".date('d-M-Y',strtotime($transport->date_create))."</td>";
											echo "<td><a href='#' class='detail_transport' ids='".$transport->id_transport."'>detail</a> | <a href='#' class='edit_transport' ids='".$transport->id_transport."'>edit</a> | <a href='#' class='delete_transport' ids='".$transport->id_transport."'>delete</a></td>";
											echo "</tr>";
										}
									}
                                ?>
                    ...
                    <div id="transport_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
                    <div id="transport_item_edit_container">
                        <form id="transport_item_form" autocomplete="off">
                            <table width="100%">
                                <tr><td width="120px"><label>Title</label></td><td><input type="text" class="text" id="pi_title" name="pi_title" /></td></tr>
								<tr><td><label>Harga</label></td><td><input type="text" class="text" id="pi_harga" name="pi_harga" />&nbsp;&nbsp;(ex : 900000)</td></tr>
                                <tr><td><label>Per</label></td><td><input type="text" class="text" id="pi_per" name="pi_per" />&nbsp;&nbsp;(ex : Jam / Hari)</td></tr>
                                <tr><td valign="top"><label>Deskripsi</label></td><td><textarea class="text area editor" id="pi_deskripsi" name="pi_deskripsi"></textarea><!--&nbsp;&nbsp;(Gunakan tag Break atau br untuk garis baru)--></td></tr>
                                <tr><td valign="top"><label>Image Thumbnail<br />(210 x 150 pixel)</label></td><td><input type="button" class="button select" id="img_upl" value="Pilih Gambar"/><input type="hidden" id="pi_path" name="pi_path" value=""/></td></tr>
            ...
            <div id="container_up3" style="display:none;">
                ...
                <div id="content_up3">
                    ...
                    <form action="<?php echo site_url('upload_transport');?>" method="post" enctype="multipart/form-data" id="upload_transport" autocomplete="off">
			...
			<div id="delete_container">
				<div class="panel_title" id="title_for_delete">Delete Transport</div>
				<div id="delete_confirm">
					Are you sure want to delete <span id="del_item">this transport</span> <b><span id="del_ket"></span></b>?<br />
