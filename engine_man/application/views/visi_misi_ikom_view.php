...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/visi_misi_ikom.js');?>"></script>
...
<div id="container">
    ...
    <div id="content-big">
		...
		<div id="main-content">
			...
			<div class="panel_title">Visi Misi IKOM</div>
				...
				<div id="container_up" style="display:none;">
					...
					<div id="content_up">
						...
						<div id="ket_up" align="center"></div>
							...
							<form action="<?php echo base_url('upload_visi_misi_ikom');?>" method="post" enctype="multipart/form-data" id="upload_visi_misi_ikom" autocomplete="off">
