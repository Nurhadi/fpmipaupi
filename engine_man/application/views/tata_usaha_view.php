...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/tata_usaha.js');?>"></script>
</head>
<body>
<div id="container">
    <div id="content-big">
        ...
        <div id="main-content">
        	<div class="panel_title">Dosen</div>
            ...
            <div class="clear"></div>
            <div class="panel_big" id="for_tata_usaha_item">
            	<div class="panel_title">Dosen<a href="#" class="act" id="tata_usaha_item_add">add</a></div>
                <div class="panel_content lef">
                	<div id="tata_usaha_item_container">
                        <div id="tata_usaha_item_container_load">
                            <table id="tata_usaha_table" width="100%" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>NIP</th>
                                ...
                                <?php
									if($jt->num_rows()>0){
										foreach($jt->result() as $tata_usaha){
											echo "<tr>";
											echo "<td>".$tata_usaha->id_tata_usaha."</td>";
											echo "<td>".$tata_usaha->nip."</td>";
											echo "<td>".$tata_usaha->nama."</td>";
											echo "<td align='center'>".strtoupper($tata_usaha->golongan)."</td>";
											echo "<td><a href='#' class='detail_tata_usaha' ids='".$tata_usaha->id_tata_usaha."'>detail</a> | <a href='#' class='edit_tata_usaha' ids='".$tata_usaha->id_tata_usaha."'>edit</a> | <a href='#' class='delete_tata_usaha' ids='".$tata_usaha->id_tata_usaha."'>delete</a></td>";
											echo "</tr>";
										}
									}
                                ?>
					...
					<style>
						#tata_usaha_item_detail_container #left_detail{display:none !important;overflow:auto;}
					</style>
                    <div id="tata_usaha_item_detail_container"><!--<div id="left_detail"></div>--><div id="right_detail"></div></div>
                    <div id="tata_usaha_item_edit_container">
                        <form id="tata_usaha_item_form" autocomplete="off">
                            <table width="100%">
								...
								<tr><td><label>Unit Kerja</label></td><td><select name="pi_unit_kerja" id="pi_unit_kerja"><?php if($jr->num_rows() > 0){foreach($jr->result() as $data){echo '<option value="'.$data->id_unit_kerja.'">'.$data->nama_unit_kerja.'</option>';}}else{echo '<option value="-">Empty</option>';}?></select></td></tr>
								<tr><td width="120px"><label>Bidang Tugas</label></td><td><textarea class="text area" id="pi_bidang_tugas" name="pi_bidang_tugas"></textarea></td></tr>
                                ...
                                <tr><td colspan="2"><div id="img_prev_container" style="width:100%;"><div id="img_prev" style="padding:0px;"></div><a href="#" id="del_img">delete image tata_usaha</a></div></td></tr>
            ...
            <div id="container_up3" style="display:none;">
                ...
                <div id="content_up3">
                    ...
                    <form action="<?php echo site_url('upload_tata_usaha');?>" method="post" enctype="multipart/form-data" id="upload_tata_usaha" autocomplete="off">
			...
			<div id="delete_container">
				<div class="panel_title" id="title_for_delete">Delete Dosen</div>
				<div id="delete_confirm">
					Are you sure want to delete <span id="del_item">this tata_usaha </span> <b><span id="del_ket"></span></b>?<br />
