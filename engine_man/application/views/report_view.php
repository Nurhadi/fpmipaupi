...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/report.js');?>"></script>
...
<div id="container">
    ...
    <div id="content-big">
		...
		<div id="main-content">
			...
			<div class="panel_title">Report</div>
				...
				<div id="container_up" style="display:none;">
					...
					<div id="content_up">
						...
						<div id="ket_up" align="center"></div>
							...
							<form action="<?php echo base_url('upload_report');?>" method="post" enctype="multipart/form-data" id="upload_report" autocomplete="off">
		...
		<div class="panel_small min" id="for_description">
			...
			<div class="panel_big" id="for_report_item">

				<div class="panel_title">Report Item<a href="#" class="act" id="report_item_add">add</a></div>

				<div class="panel_content lef">

					<div id="report_item_container">

						<div id="report_item_container_load">

							<table id="report_table" width="100%" class="display">
								...
								<tbody>
									...
									<?php
										...
										foreach($d->result() as $report){
											...
											//echo "<td>".$report->report_id."</td><td>".$report->nama."</td><td>".$report->title."</td><td><a href='".base_url('get_file/'.$param)."' target='_blank'>".$title.".pdf</a></td>";
											
											echo "<td>".$report->report_id."</td><td>".$report->nama."</td><td>".$report->title."</td><td>".$title."</a></td>";

											echo "<td><a href='#' class='detail_report' idd='".$report->report_id."'>detail</a> | <a href='#' class='edit_report' idd='".$report->report_id."'>edit</a> | <a href='#' class='delete_report' idd='".$report->report_id.",".$report->title."'>delete</a></td>";
					...
					<div id="report_item_detail"></div>

					<div id="report_item_edit_container">

						<form id="report_item_form" autocomplete="off">
							...
							<table>
								...
								<tr><td><label>File Report</label></td><td><input type="button" id="upl_btn" value="Pilih File" class="button select"/><input type="hidden" id="di_path" value="" /><div id="fl_container"><div id="upl_fl"></div><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" id="del_fl"><img src="<?php echo  base_url('assets/images/del.png');?>" style="vertical-align:middle;" /> delete file report</a></span> &nbsp;&nbsp;&nbsp;(setelah di save, file akan di rename sesuai dengan title)</div></td></tr>
			...
			<div id="delete_container">
				...
				<div class="panel_title" id="title_for_delete">Delete Report Item</div>

				<div id="delete_confirm">

					Are you sure want to delete report item <b><span id="del_ket"></span></b>?<br />
