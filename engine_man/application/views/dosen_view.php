...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/dosen.js');?>"></script>
</head>
<body>
<div id="container">
    <div id="content-big">
        ...
        <div id="main-content">
            ...
            <div class="clear"></div>
            <div class="panel_big" id="for_dosen_item">
            	<div class="panel_title">Dosen<a href="#" class="act" id="dosen_item_add">add</a></div>
                <div class="panel_content lef">
                	<div id="dosen_item_container">
                        <div id="dosen_item_container_load">
                            <table id="dosen_table" width="100%" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>NIP</th>
                                ...
                                <?php
									if($jt->num_rows()>0){
										foreach($jt->result() as $dosen){
											...
											echo "<td align='center'>".strtoupper($dosen->golongan)."</td>";
											echo "<td><a href='#' class='detail_dosen' ids='".$dosen->id_dosen."'>detail</a> | <a href='#' class='edit_dosen' ids='".$dosen->id_dosen."'>edit</a> | <a href='#' class='delete_dosen' ids='".$dosen->id_dosen."'>delete</a></td>";
											echo "</tr>";
										}
									}
                                ?>
                    ...
                    <div id="dosen_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
                    <div id="dosen_item_edit_container">
                        <form id="dosen_item_form" autocomplete="off">
                            <table width="100%">
                                <tr><td width="120px"><label>NIP</label></td><td><input type="text" class="text" id="pi_nip" name="pi_nip" /></td></tr>
                                <tr><td width="120px"><label>NIDN</label></td><td><input type="text" class="text" id="pi_nidn" name="pi_nidn" /></td></tr>
                                <tr><td width="120px"><label>Kode Dosen</label></td><td><input type="text" class="text" id="pi_kode_dosen" name="pi_kode_dosen" /></td></tr>
								...
								<tr><td width="120px"><label>Riwayat Pendidikan</label></td><td><textarea class="text area" id="pi_riwayat_pendidikan" name="pi_riwayat_pendidikan"></textarea></td></tr>
								<tr><td width="120px"><label>Kompetensi Mata Kuliah</label></td><td><textarea class="text area" id="pi_kompetensi" name="pi_kompetensi"></textarea></td></tr>
                                ...
                                <tr><td colspan="2"><div id="img_prev_container" style="width:100%;"><div id="img_prev" style="padding:0px;"></div><a href="#" id="del_img">delete image dosen</a></div></td></tr>
            ...
            <div id="container_up3" style="display:none;">
                ...
                <div id="content_up3">
                    ...
                    <form action="<?php echo site_url('upload_dosen');?>" method="post" enctype="multipart/form-data" id="upload_dosen" autocomplete="off">
			...
			<div id="delete_container">
				...
				<div id="delete_confirm">
					Are you sure want to delete <span id="del_item">this dosen </span> <b><span id="del_ket"></span></b>?<br />
