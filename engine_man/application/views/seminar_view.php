...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/seminar.js');?>"></script>
</head>
<body>
  <div id="container">
    <div id="content-big">
      ...
      <div id="main-content">
        <div class="panel_title">Seminar</div>
  ...
  <div class="clear"></div>
  <div class="panel_big" id="for_seminar_item">
    <div class="panel_title">Seminar<a href="#" class="act" id="seminar_item_add">add</a></div>
    <div class="panel_content lef">
      <div id="seminar_item_container">
        <div id="seminar_item_container_load">
          <table id="seminar_table" width="100%" class="display">
            <thead>
              <tr>
                <th>ID</th>
                <th>Title</th>
              ...
              <?php
                if($jt->num_rows()>0){
                  foreach($jt->result() as $seminar){
                    echo "<tr>";
                    echo "<td>".$seminar->id_seminar."</td>";
                    echo "<td>".$seminar->title."</td>";
                    echo "<td align='center'>".date('d-m-Y', strtotime($seminar->date)) ."</td>";
                    echo "<td align='center'>".date('d-m-Y', strtotime($seminar->date_create))."</td>";
                    echo "<td><a href='#' class='detail_seminar' ids='".$seminar->id_seminar."'>detail</a> | <a href='#' class='edit_seminar' ids='".$seminar->id_seminar."'>edit</a> | <a href='#' class='delete_seminar' ids='".$seminar->id_seminar."'>delete</a></td>";
                    echo "</tr>";
                  }
                }
              ?>
      ...
      <div id="seminar_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
        <div id="seminar_item_edit_container">
          <form id="seminar_item_form" autocomplete="off">
            <table width="100%">
            <tr><td width="120px"><label>Title</label></td><td><input type="text" class="text" id="pi_title" name="pi_title" /></td></tr>
              ...
              <tr><td colspan="2"><div id="img_prev_container" style="width:100%;"><div id="img_prev" style="padding:0px;"></div><a href="#" id="del_img">delete image seminar</a></div></td></tr>
              <tr><td width="120px"><label>Content</label></td><td><textarea class="editor" id="pi_content" name="pi_content"></textarea></td></tr>
              <tr><td width="120px"><label>Date</label></td><td><input type="text" class="text" id="pi_date" name="pi_date" /></td></tr>
    ...
    <div id="container_up3" style="display:none;">
      ...
      <div id="content_up3">
        ...
        <form action="<?php echo site_url('upload_seminar');?>" method="post" enctype="multipart/form-data" id="upload_seminar" autocomplete="off">
    ...
    <div id="delete_container">
      <div class="panel_title" id="title_for_delete">Delete Seminar</div>
      <div id="delete_confirm">
        Are you sure want to delete <span id="del_item">this seminar </span> <b><span id="del_ket"></span></b>?<br />
