...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/participant.js');?>"></script>
</head>
<body>
<div id="container">
    <div id="content-big">
        ...
        <div id="main-content">
        	<div class="panel_title">Participant</div>
            ...
            <div class="clear"></div>
            <div class="panel_big" id="for_participant_item">
            	<div class="panel_title">Participant<a href="#" class="act" id="participant_item_add">add</a></div>
                <div class="panel_content lef">
                	<div id="participant_item_container">
                        <div id="participant_item_container_load">
                            <table id="participant_table" width="100%" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Nama</th>
                                        <th align="center">Kewarganegaraan</th>
                                ...
                                <?php
									if($jt->num_rows()>0){
										foreach($jt->result() as $participant){
											...
											echo "<td>".$participant->kewarganegaraan."</td>";
											echo "<td>".$participant->jenis_kelamin."</td>";
											echo "<td><a href='#' class='detail_participant' ids='".$participant->id_participant."'>detail</a> | <a href='#' class='edit_participant' ids='".$participant->id_participant."'>edit</a> | <a href='#' class='delete_participant' ids='".$participant->id_participant."'>delete</a></td>";
											echo "</tr>";
										}
									}
                                ?>
                    ...
                    <div id="participant_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
                    <div id="participant_item_edit_container">
                        <form id="participant_item_form" autocomplete="off">
                            <table width="100%">
                                <tr><td width="120px"><label>Nama</label></td><td><input type="text" class="text" id="pi_name" name="pi_name" /></td></tr>
								<tr><td><label>Tanggal Lahir</label></td><td><input type="text" class="text" id="pi_tanggal_lahir" name="pi_tanggal_lahir" />&nbsp;&nbsp;(ex : 2013-12-31)</td></tr>
								<tr><td><label>Jenis Kelamin</label></td><td><select name="pi_jenis_kelamin" id="pi_jenis_kelamin" class="text"><option value="Laki-laki">Laki-laki</option><option value="Perempuan">Perempuan</option></select></td></tr>
                                <tr><td><label>Kewarganegaraan</label></td><td><input type="text" class="text" id="pi_kewarganegaraan" name="pi_kewarganegaraan" /></td></tr>
                               	<tr><td valign="top"><label>Foto<br />(300 x 300 pixel)</label></td><td><input type="button" class="button select" id="img_upl" value="Pilih Gambar"/><input type="hidden" id="pi_path" name="pi_path" value=""/></td></tr>
                                <tr><td colspan="2"><div id="img_prev_container" style="width:100%;"><div id="img_prev" style="padding:0px;"></div><a href="#" id="del_img">delete image participant</a></div></td></tr>
            ...
            <div id="container_up3" style="display:none;">
                ...
                <div id="content_up3">
                    ...
                    <form action="<?php echo site_url('upload_participant');?>" method="post" enctype="multipart/form-data" id="upload_participant" autocomplete="off">
			...
			<div id="delete_container">
				<div class="panel_title" id="title_for_delete">Delete Participant</div>
				<div id="delete_confirm">
					Are you sure want to delete <span id="del_item">this participant </span> <b><span id="del_ket"></span></b>?<br />
