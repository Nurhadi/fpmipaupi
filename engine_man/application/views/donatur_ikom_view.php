...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/donatur_ikom.js');?>"></script>
...
<div id="container">
    ...
    <div id="content-big">
		...
		<div id="main-content">
			...
			<div class="panel_title">Donatur IKOM</div>
				...
				<div id="container_up" style="display:none;">
					...
					<div id="content_up">
						...
						<div id="ket_up" align="center"></div>
							...
							<form action="<?php echo base_url('upload_donatur_ikom');?>" method="post" enctype="multipart/form-data" id="upload_donatur_ikom" autocomplete="off">
