...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/prestasi.js');?>"></script>
</head>
<body>
<div id="container">
    <div id="content-big">
        ...
        <div id="main-content">
        	<div class="panel_title">Prestasi</div>
            ...
            <div class="clear"></div>
            <div class="panel_big" id="for_prestasi_item">
            	<div class="panel_title">Prestasi<a href="#" class="act" id="prestasi_item_add">add</a></div>
                <div class="panel_content lef">
                	<div id="prestasi_item_container">
                        <div id="prestasi_item_container_load">
                            <table id="prestasi_table" width="100%" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Nama</th>
                                        <th align="center" width="400">Prestasi</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
									if($jt->num_rows()>0){
										foreach($jt->result() as $prestasi){
											echo "<tr>";
											echo "<td>".$prestasi->id_prestasi."</td>";
											echo "<td>".$prestasi->nama."</td>";
											echo "<td>".$prestasi->prestasi."</td>";
											echo "<td><a href='#' class='detail_prestasi' ids='".$prestasi->id_prestasi."'>detail</a> | <a href='#' class='edit_prestasi' ids='".$prestasi->id_prestasi."'>edit</a> | <a href='#' class='delete_prestasi' ids='".$prestasi->id_prestasi."'>delete</a></td>";
											echo "</tr>";
										}
									}
                                ?>
                    ...
                    <div id="prestasi_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
                    <div id="prestasi_item_edit_container">
                        <form id="prestasi_item_form" autocomplete="off">
                            <table width="100%">
								...
								<tr><td><label>Prestasi</label></td><td><textarea class="text area" id="pi_prestasi" name="pi_prestasi"></textarea></td></tr>
								<tr><td><label>Tingkat</label></td><td><input type="text" class="text" id="pi_tingkat" name="pi_tingkat" /></td></tr>
								<tr><td><label>Tahun</label></td><td><input type="text" class="text" id="pi_tahun" name="pi_tahun" /></td></tr>
            ...
            <div id="container_up3" style="display:none;">
                ...
                <div id="content_up3">
                    ...
                    <form action="<?php echo site_url('upload_prestasi');?>" method="post" enctype="multipart/form-data" id="upload_prestasi" autocomplete="off">
			...
			<div id="delete_container">
				<div class="panel_title" id="title_for_delete">Delete Prestasi</div>
				<div id="delete_confirm">
					Are you sure want to delete <span id="del_item">this prestasi </span> <b><span id="del_ket"></span></b>?<br />
