...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/kurikulum.js');?>"></script>
...
<div id="container">
    ...
    <div id="content-big">
		...
		<div id="main-content">
			...
			<div class="panel_title">Kurikulum</div>
				...
				<div id="container_up" style="display:none;">
					...
					<div id="content_up">
						...
						<div id="ket_up" align="center"></div>
							...
							<form action="<?php echo base_url('upload_kurikulum');?>" method="post" enctype="multipart/form-data" id="upload_kurikulum" autocomplete="off">
