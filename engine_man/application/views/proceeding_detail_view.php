...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/proceeding_detail.js');?>"></script>
...
<div id="container">
    ...
    <div id="content-big">
		...
		<div id="main-content">
			...
			<div class="panel_title">Proceeding Detail</div>
				...
				<div id="container_up" style="display:none;">
					...
					<div id="content_up">
						...
						<div id="ket_up" align="center"></div>
							...
							<form action="<?php echo base_url('upload_proceeding_detail');?>" method="post" enctype="multipart/form-data" id="upload_proceeding_detail" autocomplete="off">
		...
		<div class="panel_small min" id="for_description">
			...
			<div class="panel_big" id="for_proceeding_detail_item">

				<div class="panel_title">Proceeding Detail Item<a href="#" class="act" id="proceeding_detail_item_add">add</a></div>

				<div class="panel_content lef">

					<div id="proceeding_detail_item_container">

						<div id="proceeding_detail_item_container_load">

							<table id="proceeding_detail_table" width="100%" class="display">
								...
								<tbody>
									...
									<?php
										...
										foreach($d->result() as $proceeding_detail){
											...
											//echo "<td>".$proceeding_detail->proceeding_detail_id."</td><td>".$proceeding_detail->nama."</td><td>".$proceeding_detail->title."</td><td><a href='".base_url('get_file/'.$param)."' target='_blank'>".$title.".pdf</a></td>";
											
											echo "<td>".$proceeding_detail->proceeding_detail_id."</td><td>".$proceeding_detail->title."</td><td>".$title."</a></td>";

											echo "<td><a href='#' class='detail_proceeding_detail' idd='".$proceeding_detail->proceeding_detail_id."'>detail</a> | <a href='#' class='edit_proceeding_detail' idd='".$proceeding_detail->proceeding_detail_id."'>edit</a> | <a href='#' class='delete_proceeding_detail' idd='".$proceeding_detail->proceeding_detail_id.",".$proceeding_detail->title."'>delete</a></td>";
					...
					<div id="proceeding_detail_item_detail"></div>

					<div id="proceeding_detail_item_edit_container">

						<form id="proceeding_detail_item_form" autocomplete="off">

							<table>

								<tr><td width="100px"><label>Title</label></td><td><input type="text" id="di_title" name="di_title" class="text"/></td></tr>
								
								<tr><td><label>File Proceeding Detail</label></td><td><input type="button" id="upl_btn" value="Pilih File" class="button select"/><input type="hidden" id="di_path" value="" /><div id="fl_container"><div id="upl_fl"></div><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" id="del_fl"><img src="<?php echo  base_url('assets/images/del.png');?>" style="vertical-align:middle;" /> delete file proceeding detail</a></span> &nbsp;&nbsp;&nbsp;(setelah di save, file akan di rename sesuai dengan title)</div></td></tr>
			...
			<div id="delete_container">
				...
				<div class="panel_title" id="title_for_delete">Delete Proceeding_detail Item</div>

				<div id="delete_confirm">

					Are you sure want to delete proceeding detail item <b><span id="del_ket"></span></b>?<br />
