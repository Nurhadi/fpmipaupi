...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/tujuan_dan_prinsip_dasar_ikom.js');?>"></script>
...
<div id="container">
    ...
    <div id="content-big">
		...
		<div id="main-content">
			...
			<div class="panel_title">Tujuan dan Prinsip Dasar IKOM</div>
				...
				<div id="container_up" style="display:none;">
					...
					<div id="content_up">
						...
						<div id="ket_up" align="center"></div>
							...
							<form action="<?php echo base_url('upload_tujuan_dan_prinsip_dasar_ikom');?>" method="post" enctype="multipart/form-data" id="upload_tujuan_dan_prinsip_dasar_ikom" autocomplete="off">
