...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/jadwal.js');?>"></script>
</head>
<body>
<div id="container">
    <div id="content-big">
        ...
        <div id="main-content">
        	<div class="panel_title">Jadwal Trip</div>
            ...
            <div class="clear"></div>
            <div class="panel_big" id="for_jadwal_item">
            	<div class="panel_title">Jadwal Trip<a href="#" class="act" id="jadwal_item_add">add</a></div>
                <div class="panel_content lef">
                	<div id="jadwal_item_container">
                        <div id="jadwal_item_container_load">
                            <table id="jadwal_table" width="100%" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Title</th>
                                ...
                                <?php
									if($jt->num_rows()>0){
										foreach($jt->result() as $jadwal){
											...
											echo "<td>".$jadwal->title."</td>";
											echo "<td align='center'>".date('d-M-Y',strtotime($jadwal->date_start))."</td>";
											echo "<td align='center'>".date('d-M-Y',strtotime($jadwal->date_end))."</td>";
											echo "<td><a href='#' class='detail_jadwal' ids='".$jadwal->id_jadwal."'>detail</a> | <a href='#' class='edit_jadwal' ids='".$jadwal->id_jadwal."'>edit</a> | <a href='#' class='delete_jadwal' ids='".$jadwal->id_jadwal."'>delete</a></td>";
											echo "</tr>";
										}
									}
                                ?>
                    ...
                    <div id="jadwal_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
                    <div id="jadwal_item_edit_container">
                        <form id="jadwal_item_form" autocomplete="off">
                            <table width="100%">
                                <tr><td width="120px"><label>Title</label></td><td><input type="text" class="text" id="pi_title" name="pi_title" /></td></tr>
                                <tr><td><label>Bulan</label></td><td>
									<select name="pi_bulan" id="pi_bulan">
									<?php 
										if($bl->num_rows() > 0)
										{
											foreach($bl->result() as $bulan)
											{
												echo '<option value="'.$bulan->id_bulan.'">'.$bulan->bulan.' ('.$bulan->tahun.')</option>';
											}
										}
									?>
									</select>
                                ...
                                <tr><td><label>Date Start</label></td><td><input type="text" class="text" id="pi_date_start" name="pi_date_start" />&nbsp;&nbsp;(ex : 2013-12-31)</td></tr>
                                <tr><td><label>Date End</label></td><td><input type="text" class="text" id="pi_date_end" name="pi_date_end" />&nbsp;&nbsp;(ex : 2013-12-31)</td></tr>
                               	<tr><td valign="top"><label>Gambar slider<br />(300 x 240 pixel)</label></td><td><input type="button" class="button select" id="img_upl" value="Pilih Gambar"/><input type="hidden" id="pi_path" name="pi_path" value=""/></td></tr>
            ...
            <div id="container_up3" style="display:none;">
                ...
                <div id="content_up3">
                    ...
                    <form action="<?php echo site_url('upload_jadwal');?>" method="post" enctype="multipart/form-data" id="upload_jadwal" autocomplete="off">
			...
			<div id="delete_container">
				<div class="panel_title" id="title_for_delete">Delete Jadwal</div>
				<div id="delete_confirm">
					Are you sure want to delete <span id="del_item">this jadwal trip</span> <b><span id="del_ket"></span></b>?<br />
