...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/laboratorium.js');?>"></script>
</head>
<body>
<div id="container">
    <div id="content-big">
        ...
        <div id="main-content">
        	<div class="panel_title">Laboratorium</div>
            ...
            <div class="clear"></div>
            <div class="panel_big" id="for_laboratorium_item">
            	<div class="panel_title">Laboratorium<a href="#" class="act" id="laboratorium_item_add">add</a></div>
                <div class="panel_content lef">
                	<div id="laboratorium_item_container">
                        <div id="laboratorium_item_container_load">
                            <table id="laboratorium_table" width="100%" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Nama</th>
                                ...
                                <?php
									if($jt->num_rows()>0){
										foreach($jt->result() as $laboratorium){
											echo "<tr>";
											echo "<td>".$laboratorium->id_laboratorium."</td>";
											echo "<td>".$laboratorium->nama."</td>";
											echo "<td>".$laboratorium->nama_jurusan."</td>";
											echo "<td align='center'>".UCFirst($laboratorium->status)."</td>";
											echo "<td><a href='#' class='detail_laboratorium' ids='".$laboratorium->id_laboratorium."'>detail</a> | <a href='#' class='edit_laboratorium' ids='".$laboratorium->id_laboratorium."'>edit</a> | <a href='#' class='delete_laboratorium' ids='".$laboratorium->id_laboratorium."'>delete</a></td>";
											echo "</tr>";
										}
									}
                                ?>
                    ...
                    <div id="laboratorium_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
                    <div id="laboratorium_item_edit_container">
                        <form id="laboratorium_item_form" autocomplete="off">
                            <table width="100%">
            ...
            <div id="container_up3" style="display:none;">
                ...
                <div id="content_up3">
                    ...
                    <form action="<?php echo site_url('upload_laboratorium');?>" method="post" enctype="multipart/form-data" id="upload_laboratorium" autocomplete="off">
			...
			<div id="delete_container">
				<div class="panel_title" id="title_for_delete">Delete Laboratorium</div>
				<div id="delete_confirm">
					Are you sure want to delete <span id="del_item">this laboratorium </span> <b><span id="del_ket"></span></b>?<br />
