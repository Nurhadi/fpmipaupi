...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/kalender_akademik.js');?>"></script>
...
<div id="container">
    ...
    <div id="content-big">
		...
		<div id="main-content">
			...
			<div class="panel_title">Kalender Akademik</div>
				...
				<div id="container_up" style="display:none;">
					...
					<div id="content_up">
						...
						<div id="ket_up" align="center"></div>
							...
							<form action="<?php echo base_url('upload_kalender_akademik');?>" method="post" enctype="multipart/form-data" id="upload_kalender_akademik" autocomplete="off">
