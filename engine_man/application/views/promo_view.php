...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/promo.js');?>"></script>
</head>
<body>
<div id="container">
    <div id="content-big">
        ...
        <div id="main-content">
        	<div class="panel_title">Promo</div>
            ...
            <div class="clear"></div>
            <div class="panel_big" id="for_promo_item">
            	<div class="panel_title">Promo Item<a href="#" class="act" id="promo_item_add">add</a></div>
                <div class="panel_content lef">
                	<div id="promo_item_container">
                        <div id="promo_item_container_load">
                            <table id="promo_table" width="100%" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Title</th>
                                        <th align="center">Date Create</th>
                                        <th align="center">Date Limit</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
									if($pr->num_rows()>0){
										foreach($pr->result() as $store){
											echo "<tr>";
											echo "<td>".$store->id_promo."</td>";
											echo "<td>".$store->title."</td>";
											echo "<td align='center'>".date('d-M-Y',strtotime($store->date_create))."</td>";
											echo "<td align='center'>".date('d-M-Y',strtotime($store->date_limit))."</td>";
											echo "<td><a href='#' class='detail_promo' ids='".$store->id_promo."'>detail</a> | <a href='#' class='edit_promo' ids='".$store->id_promo."'>edit</a> | <a href='#' class='delete_promo' ids='".$store->id_promo."'>delete</a></td>";
											echo "</tr>";
										}
									}
                                ?>
                    ...
                    <div id="promo_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
                    <div id="promo_item_edit_container">
                        <form id="promo_item_form" autocomplete="off">
                            <table width="100%">
                                ...
                                <tr><td><label>Date Limit</label></td><td><input type="text" class="text" id="pi_date_limit" name="pi_date_limit" />&nbsp;&nbsp;(Ex : 2013-12-31)</td></tr>
								<tr><td valign="top"><label>Isi Promo</label></td><td><textarea class="text area editor" id="pi_content" name="pi_content"></textarea><!--&nbsp;&nbsp;(Gunakan tag Break atau br untuk garis baru)--></td></tr>
                                <tr><td><label>Budget</label></td><td><input type="text" class="text" id="pi_budget" name="pi_budget" />&nbsp;&nbsp;(ex : 900000)</td></tr>
								<tr><td valign="top"><label>Destinasi</label></td><td><textarea class="text area editor2" id="pi_destinasi" name="pi_destinasi"></textarea><!--&nbsp;&nbsp;(Gunakan tag Break atau br untuk garis baru)--></td></tr>
                                <tr><td valign="top"><label>Deskripsi</label></td><td><textarea class="text area editor3" id="pi_deskripsi" name="pi_deskripsi"></textarea><!--&nbsp;&nbsp;(Gunakan tag Break atau br untuk garis baru)--></td></tr>
                                <tr><td valign="top"><label>Terms & Conditions</label></td><td><textarea class="text area editor4" id="pi_term" name="pi_term"></textarea><!--&nbsp;&nbsp;(Gunakan tag Break atau br untuk garis baru)--></td></tr>
								<tr><td><label>Note</label></td><td><input type="text" class="text" id="pi_note" name="pi_note" />&nbsp;&nbsp;(Maksimal 200 karakter)</td></tr>
            ...
            <div id="container_up3" style="display:none;">
                ...
                <div id="content_up3">
                    ...
                    <form action="<?php echo site_url('upload_promo');?>" method="post" enctype="multipart/form-data" id="upload_promo" autocomplete="off">
			...
			<div id="delete_container">
				<div class="panel_title" id="title_for_delete">Delete Promo</div>
				<div id="delete_confirm">
					Are you sure want to delete <span id="del_item">this promo item</span> <b><span id="del_ket"></span></b>?<br />
