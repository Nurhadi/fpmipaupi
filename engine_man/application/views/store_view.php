...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/store.js');?>"></script>
</head>
<body>
<div id="container">
    <div id="content-big">
        ...
        <div id="main-content">
        	<div class="panel_title">Store</div>
            ...
            <div class="clear"></div>
            <div class="panel_big" id="for_store_item">
            	<div class="panel_title">Store Item<a href="#" class="act" id="store_item_add">add</a></div>
                <div class="panel_content lef">
                	<div id="store_item_container">
                        <div id="store_item_container_load">
                            <table id="store_table" width="100%" class="display">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Title</th>
                                ...
                                <?php
									if($st->num_rows()>0){
										foreach($st->result() as $store){
											echo "<tr>";
											echo "<td>".$store->id_store."</td>";
											echo "<td>".$store->title."</td>";
											echo "<td align='center'>Rp ".number_format($store->harga,0,'','.')." / ".$store->satuan."</td>";
											echo "<td align='center'>".date('d-M-Y',strtotime($store->date_create))."</td>";
											echo "<td><a href='#' class='detail_store' ids='".$store->id_store."'>detail</a> | <a href='#' class='edit_store' ids='".$store->id_store."'>edit</a> | <a href='#' class='delete_store' ids='".$store->id_store."'>delete</a></td>";
											echo "</tr>";
										}
									}
                                ?>
                    ...
                    <div id="store_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
                    <div id="store_item_edit_container">
                        <form id="store_item_form" autocomplete="off">
                            <table width="100%">
            ...
            <div id="container_up3" style="display:none;">
                ...
                <div id="content_up3">
                    ...
                    <form action="<?php echo site_url('upload_store');?>" method="post" enctype="multipart/form-data" id="upload_store" autocomplete="off">
			...
			<div id="delete_container">
				<div class="panel_title" id="title_for_delete">Delete Store</div>
				<div id="delete_confirm">
					Are you sure want to delete <span id="del_item">this store item</span> <b><span id="del_ket"></span></b>?<br />
