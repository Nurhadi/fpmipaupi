...
<script type="text/javascript" src="<?php echo base_url('assets/scripts/lowongan_kerja.js');?>"></script>
</head>
<body>
  <div id="container">
    <div id="content-big">
      ...
      <div id="main-content">
        <div class="panel_title">Lowongan Kerja</div>
  ...
  <div class="clear"></div>
  <div class="panel_big" id="for_lowongan_kerja_item">
    <div class="panel_title">Lowongan Kerja<a href="#" class="act" id="lowongan_kerja_item_add">add</a></div>
    <div class="panel_content lef">
      <div id="lowongan_kerja_item_container">
        <div id="lowongan_kerja_item_container_load">
          <table id="lowongan_kerja_table" width="100%" class="display">
            <thead>
              <tr>
                <th>ID</th>
                <th>Title</th>
              ...
              <?php
                if($jt->num_rows()>0){
                  foreach($jt->result() as $lowongan_kerja){
                    echo "<tr>";
                    echo "<td>".$lowongan_kerja->id_lowongan_kerja."</td>";
                    echo "<td>".$lowongan_kerja->title."</td>";
                    echo "<td align='center'>".date('d-m-Y', strtotime($lowongan_kerja->date_create))."</td>";
                    echo "<td><a href='#' class='detail_lowongan_kerja' ids='".$lowongan_kerja->id_lowongan_kerja."'>detail</a> | <a href='#' class='edit_lowongan_kerja' ids='".$lowongan_kerja->id_lowongan_kerja."'>edit</a> | <a href='#' class='delete_lowongan_kerja' ids='".$lowongan_kerja->id_lowongan_kerja."'>delete</a></td>";
                    echo "</tr>";
                  }
                }
              ?>
      ...
      <div id="lowongan_kerja_item_detail_container"><div id="left_detail"></div><div id="right_detail"></div></div>
        <div id="lowongan_kerja_item_edit_container">
          <form id="lowongan_kerja_item_form" autocomplete="off">
            <table width="100%">
            <tr><td width="120px"><label>Title</label></td><td><input type="text" class="text" id="pi_title" name="pi_title" /></td></tr>
              <tr><td width="120px"><label>Meta Keywords</label></td><td><input type="text" class="text" id="pi_meta_keywords" name="pi_meta_keywords" /></td></tr>
              <tr><td width="120px"><label>Meta Description</label></td><td><input type="text" class="text" id="pi_meta_description" name="pi_meta_description" /></td></tr>
              ...
              <tr><td colspan="2"><div id="img_prev_container" style="width:100%;"><div id="img_prev" style="padding:0px;"></div><a href="#" id="del_img">delete image lowongan_kerja</a></div></td></tr>
              <tr><td width="120px"><label>Content</label></td><td><textarea class="editor" id="pi_content" name="pi_content"></textarea></td></tr>
    ...
    <div id="container_up3" style="display:none;">
      ...
      <div id="content_up3">
        ...
        <form action="<?php echo site_url('upload_lowongan_kerja');?>" method="post" enctype="multipart/form-data" id="upload_lowongan_kerja" autocomplete="off">
    ...
    <div id="delete_container">
      <div class="panel_title" id="title_for_delete">Delete Lowongan Kerja</div>
      <div id="delete_confirm">
        Are you sure want to delete <span id="del_item">this lowongan_kerja </span> <b><span id="del_ket"></span></b>?<br />
