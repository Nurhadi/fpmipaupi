...
$(document).ready(function(){
	...
	$("#sarana_prasarana_table").dataTable({
		"bAutoWidth": false,
		"bProcessing": true,
	...
	$("#keyword_form").submit(function(){
		...
		dataString+="&page_id=16&ctn_t_name_em="+cct;
		$.ajax({
			type:"POST",
			data:dataString,
			...
			success:function(msg){
				if(msg==1){
					setTimeout(function(){
						...
						$("#ket").fadeIn();
						var t=new Date();
						$("#keyword_container").empty().load("sarana_prasarana.html?"+t.getTime()+" #keyword_container_load",function(){
							setTimeout(function(){
								$("#ket").hide();
								$("#imgket").fadeIn();
								$("#keyword_edit_container").hide();
			...
			success:function(msg){
				if(msg==1){
					setTimeout(function(){
						...
						$("#ket").fadeIn();
						var t=new Date();
						$("#description_container").empty().load("sarana_prasarana.html?"+t.getTime()+" #description_container_load",function(){
							setTimeout(function(){
								$("#ket").hide();
								$("#imgket").fadeIn();
								$("#description_edit_container").hide();
			...
			success:function(msg){
				if(msg==1){
					setTimeout(function(){
						...
						$("#ket").fadeIn();
						var t=new Date();
						$("#title_container").empty().load("sarana_prasarana.html?"+t.getTime()+" #title_container_load",function(){
							setTimeout(function(){
								$("#ket").hide();
								$("#imgket").fadeIn();
								$("#title_edit_container").hide();
	...
	$("#delete_yes").click(function(){
		...
		$.ajax({
			type:"POST",
			data:dataString,
			url:base_url+"sarana_prasarana/delete_sarana_prasarana",
			success:function(msg){
				if(msg==1){
					setTimeout(function(){
						$("#imgket_delete").hide();
						$("#ket_delete").fadeIn();
						var t=new Date();
						$("#sarana_prasarana_item_container").empty().load("sarana_prasarana.html?"+t.getTime()+" #sarana_prasarana_item_container_load",function(){
							$("#sarana_prasarana_table").dataTable({
								"bAutoWidth": false,
								"bProcessing": true,
								"sPaginationType": "full_numbers",
	...
	$("#sarana_prasarana_item_add").click(function(){
		acti="add";
		$("#sarana_prasarana_item_container").hide();
		$("#sarana_prasarana_item_detail_container").hide();
		$("#sarana_prasarana_item_edit_container").fadeIn();
		return false;
	});
	...
	$("#pi_cancel").click(function(){
		...
		$("#sarana_prasarana_item_edit_container").hide();
		$("#sarana_prasarana_item_container").fadeIn();
		return false;
	});
	
	$("#sarana_prasarana_item_form").submit(function(){
		$("#ket").hide();
		$("#imgket").fadeIn();
		$("#for_sarana_prasarana_item").block({message:$("#loader"),css:{padding:'5px','-webkit-border-radius': '7px','-moz-border-radius': '7px','border-radius': '7px'}});
		var n=$("#pi_name").val();
		var d=$("#pi_desc").val();
		...
		var cct = $.cookie('em_ccn_c_name_em');
		if(acti=='edit'){
			var dataString="id_sarana_prasarana="+idsarana_prasarana+"&name="+n+"&jurusan="+jr+"&description="+d+"&jumlah="+jm+"&acti="+acti+"&ctn_t_name_em="+cct;
		}else{
			var dataString="name="+n+"&jurusan="+jr+"&description="+d+"&jumlah="+jm+"&acti="+acti+"&ctn_t_name_em="+cct;
		}
		$.ajax({
			type:"POST",
			url:base_url+"sarana_prasarana/save_sarana_prasarana",
			data:dataString,
			success:function(msg){
				setTimeout(function(){
					$("#imgket").hide();
					...
					$("#sarana_prasarana_item_container").empty().load("sarana_prasarana.html?"+t.getTime()+" #sarana_prasarana_item_container_load",function(){
						...
						setTimeout(function(){
							...
							$("#pi_jumlah").val('');
							$("#sarana_prasarana_item_container").fadeIn();
							$("#for_sarana_prasarana_item").unblock();
						},1000);
					});
				},1000);
			}
...
function act_prod(){
	$(".detail_sarana_prasarana").click(function(){
		$("#ket").hide();
		$("#imgket").fadeIn();
		$("#for_sarana_prasarana_item").block({message:$("#loader"),css:{padding:'5px','-webkit-border-radius': '7px','-moz-border-radius': '7px','border-radius': '7px'}});
		var id_sarana_prasarana=$(this).attr("ids");
		var t=new Date();
		$("#sarana_prasarana_item_detail_container").empty().load(base_url+"detail_sarana_prasarana/"+id_sarana_prasarana+"/"+t.getTime(),function(){
			...
			setTimeout(function(){
				$("#sarana_prasarana_item_container").hide();
				$("#sarana_prasarana_item_detail_container").fadeIn();
				$("#for_sarana_prasarana_item").unblock();
			},1000);
		});
		return false;
	...
	$(".delete_sarana_prasarana").click(function(){
	...
	$(".edit_sarana_prasarana").click(function(){
		$("#ket").hide();
		$("#imgket").fadeIn();
		$("#for_sarana_prasarana_item").block({message:$("#loader"),css:{padding:'5px','-webkit-border-radius': '7px','-moz-border-radius': '7px','border-radius': '7px'}});
		acti="edit";
		idsarana_prasarana=$(this).attr("ids");
		var cct = $.cookie('em_ccn_c_name_em');
		var dataString="id_sarana_prasarana="+idsarana_prasarana+"&ctn_t_name_em="+cct;
		$.ajax({
			type:"POST",
			url:base_url+"sarana_prasarana/get_data_sarana_prasarana",
			data:dataString,
